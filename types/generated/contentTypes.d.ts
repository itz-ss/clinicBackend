...
export interface ApiEducationalVideoEducationalVideo
  ...
  info: {
    displayName: 'Educational Video';
    pluralName: 'educational-videos';
    singularName: 'educational-video';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::educational-video.educational-video',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    ...
    > &
      Attribute.Private;
    videoFile: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    Date: Attribute.Date;
    Events: Attribute.Component<'media.media-item', true>;
...
export interface ApiMediaMedia extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    photo: Attribute.Media<'images' | 'files', true>;
    ...
    > &
      Attribute.Private;
    videoFile: Attribute.Media<'videos', true>;
...
export interface ApiPodcastPodcast extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    guestDesignation: Attribute.String;
    guestName: Attribute.String;
    Podcast: Attribute.Component<'media.media-item'>;
    publishedAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::podcast.podcast',
...
export interface ApiTestimonialTestimonial extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    patientName: Attribute.String;
    publishedAt: Attribute.DateTime;
    Testimonial: Attribute.Component<'media.media-item'>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::testimonial.testimonial',
      'oneToOne',
